...
const simulations = [
  ...
  { id:"diffusion-tube-sim", title:"HCl and NH3 Diffusion Tube", topic:"Kinetic Theory of Matter", level:"GCSE",
    desc:"Animated diffusion tube for the reaction between hydrogen chloride and ammonia. Temperature, air particles and reactant particles can be adjusted.", file:"simulations/diffusion-tube-sim.html", notes:"" },
  { id:"ph-curve-sim", title:"Acid–Base Titration", topic:"Acids & Bases", level:"A-level",
    ...
    desc:"Formation of molecular orbitals from two 1s orbitals.", file:"simulations/mo-formation-sim.html",
    ...
    desc:"Molecular orbital diagrams for Period 2 heteronuclear diatomic molecules — pick any two elements.",  file:"simulations/mo-formation-heteronuclear-sim.html",
